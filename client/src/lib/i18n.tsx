...
const zh: Record<string, string> = {
  ...
  'Avg latency': '平均延迟',
  'Est. savings': '估算节省',
  'Daily token heatmap': '每日 token 用量热力图',
  'Daily token usage heatmap': '每日 token 用量热力图',
  'Past 17 weeks': '近 17 周',
  'Full year view': '按全年查看每日 token 用量',
  'Less': '少',
  'More': '多',
  'Total tokens': '总 token 用量',
  'Daily average': '日均 token 用量',
  'Peak day': '峰值日期',
  'Day details': '日期详情',
  'Hovered day': '悬停日期',
  'Hover a square': '将鼠标移到方块上查看日期明细',
  'Total requests': '总请求数',
  'tokens': 'token',
  'requests': '次请求',
  'Week': '周',
